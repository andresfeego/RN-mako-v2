...
export default class SwiperHeaderDirectorio extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Swiper
         autoplay
         paginationStyle={{top: -280}}
         autoplayTimeout={6}
         activeDot={<View style={{backgroundColor: '#f33446', width: 18, height: 8, borderRadius: 4, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />}
